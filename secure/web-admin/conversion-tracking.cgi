...
while (my $q = new mySociety::CGIFast()) {
    ...
    my %current;
    $current{writetothem}{'advert=cheltenhamhfyc0'} = "<h2>Cool! You live in Cheltenham!</h2> <p>We\\'ve got an exciting new free service that works exclusively for people in Cheltenham. Please sign up to help the charity that runs WriteToThem, and to get a sneak preview of our new service.</p>";
