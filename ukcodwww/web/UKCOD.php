 ...
 * @subpackage Skins
 */
class SkinLOTL extends SkinTemplate {
	function initPage( &$out ) {
		SkinTemplate::initPage( $out );
		$this->skinname  = 'lotl';
		$this->stylename = 'lotl';
		$this->template  = 'LOTLTemplate';
	}
}
 ...
 * @subpackage Skins
 */
class LOTLTemplate extends QuickTemplate {
	/**
	...
	function execute() {
        ...
        include("http://".$_SERVER['HTTP_HOST']."/header.py");
?>
...
<?php
	wfRestoreWarnings();
    include("http://".$_SERVER['HTTP_HOST']."/footer.py");
	}
}
