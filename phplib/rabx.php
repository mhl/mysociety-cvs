 ...
 *
 * $Id: rabx.php,v 1.27 2011-08-12 05:39:56 matthew Exp $
 * 
 */
...
class RABX_Client {
    ...
    function RABX_Client($url, $userpwd = null) {
        ...
        curl_setopt($this->ch, CURLOPT_USERAGENT, 'PHP RABX client, version $Id: rabx.php,v 1.27 2011-08-12 05:39:56 matthew Exp $');
