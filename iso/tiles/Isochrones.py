...
$Id: Isochrones.py,v 1.34 2009-09-24 22:24:47 francis Exp $
"""
import os
import sys
import time
...
class TileLayer(TileCache.Layer.MetaLayer):
    ...
    def renderTile(self, tile, force=None):
        ...
        raise repr(tile.bounds()) + " " + repr(len(points)) + " " + repr(points)
...
def draw_tile(points, tile, log):
    ...
    if points_time <= 0.00001:
        points_time = 0.00001 # stop division by zero
