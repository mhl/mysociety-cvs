...
//
// $Id: makeplan.h,v 1.14 2009-05-01 00:21:51 francis Exp $
//
...
class PlanningATCO {
    ...
    */
    PlanningATCO(int l_general_interchange_default = 5, int l_bus_interchange_default = 1, float l_walk_speed=1.34, float l_walk_time=1800.0 
    ) {
